...
export function createOpenClawTools(
  ...
  const tools: AnyAgentTool[] = [
    ...
    ...(options?.requesterSenderId
      ? [
          createCustomerDossierTool(options.requesterSenderId),
          createCustomerDemandSignalsTool(options.requesterSenderId),
          createCustomerGetTool(options.requesterSenderId),
          createCustomerUpsertTool(options.requesterSenderId),
          createCustomerInvoiceTool(options.requesterSenderId),
          createCustomerIntentCandidatesTool(options.requesterSenderId),
          createCustomerRecordInteractionTool(options.requesterSenderId),
          createCustomerSafePricingTool(options.requesterSenderId),
        ]
      : []),
  ];
